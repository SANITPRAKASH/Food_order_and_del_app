...
const Add = () => {
    ...
    const url = "http://localhost:3000"; // Correct backend URL
            ...
            <form className='flex-col' onSubmit={onSubmitHandler}>
                ...
                <div className="add-category-price">
                    ...
                    <div className="add-price flex-col">
                        <p>Product Price</p>
                        <input className='inputclasa' onChange={onChangeHandler} value={data.price} type="number" name='price' placeholder='₹ 00' required />
                    </div>
                </div>
